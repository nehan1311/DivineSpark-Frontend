            ...
            <header className={`${styles.header} ${scrolled ? styles.scrolled : ''}`}>
                <div className={`${styles.headerContainer}`}>
                    ...
                    <nav className={styles.nav}>
                        ...
                        >
                            <button
                                className={`${styles.navLink} ${location.pathname.includes('/programs') ? styles.active : ''}`}
                            ...
                            {programsOpen && (
                                <div className={styles.dropdown}>
                                    <Link
                                        to="/programs/energy-workshops"
                                        className={styles.dropdownItem}
                                        onClick={() => setProgramsOpen(false)}
                                    >
                                        Energy Workshops
                                    </Link>
                                    <div className={styles.dropdownDivider} style={{ margin: '0' }} />
                                    <Link
                                        to="/programs/spiritual-trips"
                                        className={styles.dropdownItem}
                                        onClick={() => setProgramsOpen(false)}
                                    >
                                        Spiritual Trips
